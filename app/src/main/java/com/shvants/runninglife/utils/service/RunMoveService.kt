...
class RunMoveService : IService<MoveModelUi> {
    ...
    init {
        moves.add(RunMoveModelUi(1, 1000000, "Morning Run", 10.00, (1 * 3600 + 23 * 60 + 45), 100, 500, 130))
        moves.add(RunMoveModelUi(2, 2000000, "Afternoon Run", 15.00, (0 * 3600 + 23 * 60 + 45), 150, 800, 140))
        moves.add(RunMoveModelUi(3, 3000000, "Night Run", 6.00, (1 * 3600 + 0 * 60 + 45), 10, 200, 110))
        moves.add(RunMoveModelUi(3, 3000000, "Night Run", 6.00, (1 * 3600 + 0 * 60 + 45), 10, 200, 110))
        moves.add(RunMoveModelUi(3, 3000000, "Night Run", 6.00, (1 * 3600 + 0 * 60 + 45), 10, 200, 110))
        moves.add(RunMoveModelUi(3, 3000000, "Night Run", 6.00, (1 * 3600 + 0 * 60 + 45), 10, 200, 110))
        moves.add(RunMoveModelUi(3, 3000000, "Night Run", 6.00, (1 * 3600 + 0 * 60 + 45), 10, 200, 110))
